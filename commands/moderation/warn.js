...
class warn extends Command {
  ...
  async run(bot, msg, args, level) {
    ...
    let reason = args.filter(words => words != msg.mentions.users.first()).join(" ");
    ...
    msg.channel.send("**" +
            ...
            "** has been given their " + warning.case + " warning. Reason: " + warning.reason
        );
